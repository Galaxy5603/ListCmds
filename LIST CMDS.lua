listcmds = {
    ...
    [4] = print("/q, takes you to queue"),
    [5] = print("/e, takes you to earth"),
    [6] = print("/n, takes you to namek"),
    [7] = print("/s, takes you to space"),
    [8] = print("/f, takes you to future"),
    [9] = print("/s, takes you to secret world"),
    [10] = print("/z, takes you to zaros world"),
    [11] = print("/h, takes you to heaven"),
    [12] = print("/south,/west,/central,/spawn,/lookout,/mountains,/brokecity,/namekship,/padbr,/padtop,/padhard"),
    ...
    [34] = print("/beerus,/be,BEERUS ANIMATION,/whis,/aws,WHIS ANIMATION,/snake,/sk,SNAKEWORLD ANIMATION,/bdl,/ba,BABAIDLE ANIMATION"),
